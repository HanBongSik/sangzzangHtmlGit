                            ...
                            <div class="c c-full-width shadow">
                                ...
                                <div class="sangzzang sangzzang-origin sangzzang-view">
                                    <div class="sz-wrting sz-ratio sz-write clearfix" id="captureArea">
                                        ...
                                        <div class="sz-word">
                                            <div><br>
                                                어린 나이에 앱 서비스를 오픈한 경험을 가지고 있고,
                                                빈번한 미소와 웃음으로 평온함과 안정된 느낌을 받게 해주어
                                                이 상을 드립니다. </div>
                                        </div>
                                        <div class="sz-date">
                                        ...
                                        <div class="sz-stamp">
                                            <a href="#;">
                                                <img class="sz-stamp-img" src="/assets/img/design/stp/qr_kyj.png" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="r">
                            <div class="c c-full-width ">
                                ...
                                <div class="sz-function sz-function-01 shadow">
                                    ...
                                    <a href="/pages/3d-card-share-kyj.php" id="download">
										<span class="copy last">
                    ...
                    <div class="photo">
                        ...
                        <div class="swiper-container">
                            <ul class="swiper-wrapper">
                                <li class="swiper-slide" style="background-image:url(https://i.namu.wiki/i/DtgPzZ7Q6LBCQJ_UPH7uyIFU4z0ZYbU7jn3jcSGle4aWb3Xq6NGsQf1X7KivVzgOKNYa32zriP_hzZVIi18gKQ.webp)"></li>

                                <li class="swiper-slide" style="background-image:url(https://cdn.ccdailynews.com/news/photo/202106/2062108_539640_4340.jpg)"></li>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="download-modal">
                                ...
                                <ul class="modal-list">
                                    <li class="last"><button type="button" class="button secondary block x-large close" tabindex="0">취소</button></li>
                                </ul>
                            </div>
                        </div>
                        <!-- 모달 바디 End -->
