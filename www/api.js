...
const impreciContentService = new ImpreciContentService(); // ImpreciContentService 객체를 생성합니다.
impreciContentService.start(port); // 애플리케이션을 시작합니다.