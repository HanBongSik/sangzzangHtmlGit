...
<head>
    ...
    <!-- lib -->
    <script src="/assets/lib/js/jquery-3.6.3.min.js?v=1"></script>
    <script src="/assets/lib/js/jquery-ui.js?v=1"></script>
    <link href="/assets/lib/css/jquery-ui.css?v=1" type="text/css" rel="stylesheet"/>
    <!-- lib End -->
...
<div class="__guide__wrapper">
    ...
    <?php include('./container-grid.php')?>
