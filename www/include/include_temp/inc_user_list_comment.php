                                        ...
                                        <div class="r">
                                            <div class="c">
                                                <div class="user-action-info-detail">
                                                    <span class="user-id">blackpinkofficial</span>
                                                    <span class="user-alarm">님이 상장을 보냈습니다.</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="r">
                                ...
                                <div class="c">
                                    <div class="g">
                                        <div class="r">
                                            <div class="c">
                                                <div class="user-action-info-detail">
                                                    <span class="user-id">dlwlrma</span>
                                                    <span class="user-alarm">님이 상장을 보냈습니다.</span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="c">
                                    <div class="g">
                                        <div class="r">
                                            <div class="c">
                                                <div class="user-action-info-detail">
                                                    <span class="user-id">leedongwook_official</span>
                                                    <span class="user-alarm">님이 상장을 보냈습니다.</span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="c">
                                    <div class="g">
                                        <div class="r">
                                            <div class="c">
                                                <div class="user-action-info-detail">
                                                    <span class="user-id">hi_high_hiy</span>
                                                    <span class="user-alarm">님이 상장을 보냈습니다.</span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="c">
                                    <div class="g">
                                        <div class="r">
                                            <div class="c">
                                                <div class="user-action-info-detail">
                                                    <span class="user-id">yoona__lim</span>
                                                    <span class="user-alarm">님이 상장을 보냈습니다.</span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="c">
                                    <div class="g">
                                        <div class="r">
                                            <div class="c">
                                                <div class="user-action-info-detail">
                                                    <span class="user-id">yawnzzn</span>
                                                    <span class="user-alarm">님이 상장을 보냈습니다.</span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="c">
                                    <div class="g">
                                        <div class="r">
                                            <div class="c">
                                                <div class="user-action-info-detail">
                                                    <span class="user-id">__youngbae__</span>
                                                    <span class="user-alarm">님이 상장을 보냈습니다.</span>
                                                </div>
                                            </div>
                                        </div>
