<div class="__list">
    <div class="__figure">
        <div class="__element">
            ...
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalFullSample02">모달 full Up</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalFullSample03">모달 full Down</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalFullSample04">모달 full Left</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalFullSample05">모달 full Right</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalFullSample06">모달 center</button>
        </div>
...
<div class="modal-dimmed" data-ani-on="modal-ani-up" data-ani-off="modal-ani-up-down" id="modalFullSample02">
    <div class="modal-full">
        <div class="modal-wrapper">
            <div class="modal-container">
                <div class="modal-content">
...
<div class="modal-dimmed" data-ani-on="modal-ani-down" data-ani-off="modal-ani-down-up" id="modalFullSample03">
    <div class="modal-full">
        <div class="modal-wrapper">
            <div class="modal-container">
                <div class="modal-content">
...
<div class="modal-dimmed" data-ani-on="modal-ani-left" data-ani-off="modal-ani-left-right" id="modalFullSample04">
    <div class="modal-full">
        <div class="modal-wrapper">
            <div class="modal-container">
                <div class="modal-content">
...
<div class="modal-dimmed" data-ani-on="modal-ani-right" data-ani-off="modal-ani-right-left" id="modalFullSample05">
    <div class="modal-full">
        <div class="modal-wrapper">
            <div class="modal-container">
                <div class="modal-content">
...
<div class="modal-dimmed" data-ani-on="modal-ani-big" data-ani-off="modal-ani-big-small" id="modalFullSample06">
    <div class="modal-full">
        <div class="modal-wrapper">
            <div class="modal-container">
                <div class="modal-content">
