<div class="__list">
    <div class="__figure">
        <div class="__element">
            ...
            <button type="button" class="btn MODAL-BTN" data-target="#modalHeightFullSample11">모달 높이만 full</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample12">모달 높이만 full Up</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample13">모달 높이만 full Down</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample14">모달 높이만 full Left</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample15">모달 높이만 full Right</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample16">모달 높이만 center</button>
        </div>
        <div class="__class">.MODAL-BTN</div>
    </div>
</div>

<div class="modal-dimmed MODAL-DIMMED-CLOSE" id="modalSampleOpacityTarget01" data-ani-on="modal-ani-opacity" data-ani-off="modal-ani-opacity-opacity">
...
<div class="modal-dimmed MODAL-DIMMED-CLOSE" id="modalHeightFullSample11">
    <div class="modal-full modal-height-full">
        <div class="modal-wrapper">
            <div class="modal-container">
                <div class="modal-content">
...
<div class="modal-dimmed MODAL-DIMMED-CLOSE" id="modalHeightFullSample12">
    <div class="modal-full modal-height-full">
        <div class="modal-wrapper">
            <div class="modal-container">
...
<div class="modal-dimmed MODAL-DIMMED-CLOSE" id="modalHeightFullSample13">
    <div class="modal-full modal-height-full">
        <div class="modal-wrapper">
            <div class="modal-container">
...
<div class="modal-dimmed MODAL-DIMMED-CLOSE" id="modalHeightFullSample14">
    <div class="modal-full modal-height-full">
        <div class="modal-wrapper">
            <div class="modal-container">
...
<div class="modal-dimmed MODAL-DIMMED-CLOSE" id="modalHeightFullSample15">
    <div class="modal-full modal-height-full">
        <div class="modal-wrapper">
            <div class="modal-container">
...
<div class="modal-dimmed MODAL-DIMMED-CLOSE" id="modalHeightFullSample16">
    <div class="modal-full modal-height-full">
        <div class="modal-wrapper">
            <div class="modal-container">
