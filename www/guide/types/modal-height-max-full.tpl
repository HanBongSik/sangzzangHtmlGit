<div class="__list">
    <div class="__figure">
        <div class="__element __text-left">
            <button type="button" class="btn MODAL-BTN" data-target="#modalHeightMaxFullSampleOpacityTarget01">모달 - Opacity-Target</button>
            <button type="button" class="btn MODAL-BTN" data-target="#modalHeightMaxFullSampleTarget01">모달 최대 높이 full- Target</button>
            <button type="button" class="btn MODAL-BTN" data-target="#modalHeightMaxFullSample01">모달 최대 높이 full</button>
            <button type="button" class="btn MODAL-BTN" data-target="#modalHeightMaxFullSample02">모달 최대 높이 full - Long</button><br>
            <br>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightMaxFullSample03">모달 최대 높이 center</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightMaxFullSample04">모달 최대 높이 center1</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightMaxFullSample05">모달 최대 높이 center2</button><br>
            <br>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightMaxFullSample06">모달 최대 높이 full Up</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightMaxFullSample07">모달 최대 높이 full Down</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightMaxFullSample08">모달 최대 높이 full Left</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightMaxFullSample09">모달 최대 높이 full Right</button><br>
...
<div class="modal-dimmed" id="modalHeightMaxFullSampleOpacityTarget01" data-ani-on="modal-ani-opacity" data-ani-off="modal-ani-opacity-opacity">
...
<div class="modal-dimmed" id="modalHeightMaxFullSampleTarget01">
    <div class="modal-full modal-height-max-full">
        <div class="modal-wrapper">
            <div class="modal-container">
                <div class="modal-content" data-ani-on="modal-ani-target" data-ani-off="modal-ani-target-target">
...
<div class="modal-dimmed" data-ani-on="modal-ani-big" data-ani-off="modal-ani-big-small" id="modalHeightMaxFullSample03">
    <div class="modal-full modal-height-max-full">
        <div class="modal-wrapper">
            <div class="modal-container">
...
<div class="modal-dimmed" data-ani-on="modal-ani-big" data-ani-off="modal-ani-big-small" id="modalHeightMaxFullSample05">
    <div class="modal-full modal-height-max-full">
        <div class="modal-wrapper">
            <div class="modal-container">
                <div class="modal-content" data-ani-on="modal-ani-big" data-ani-off="modal-ani-big-small">
...
<div class="modal-dimmed" id="modalHeightMaxFullSample08">
    <div class="modal-full modal-height-max-full">
        <div class="modal-wrapper">
            <div class="modal-container">
...
<div class="modal-dimmed" id="modalHeightMaxFullSample09">
    <div class="modal-full modal-height-max-full">
        <div class="modal-wrapper">
            <div class="modal-container">
