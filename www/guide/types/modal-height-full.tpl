<div class="__list">
    <div class="__figure">
        <div class="__element">
            ...
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample02">모달 높이만 full Up</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample03">모달 높이만 full Down</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample04">모달 높이만 full Left</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample05">모달 높이만 full Right</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample06">모달 높이만 center</button>
        </div>
