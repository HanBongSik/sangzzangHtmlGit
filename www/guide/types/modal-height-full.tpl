<div class="__list">
    <div class="__figure">
        <div class="__element __text-left">
            <button type="button" class="btn MODAL-BTN" data-target="#modalHeightFullSampleOpacityTarget01">모달 - Opacity-Target</button>
            <button type="button" class="btn MODAL-BTN" data-target="#modalHeightFullSampleTarget01">모달 높이만 full - Target</button>
            <button type="button" class="btn MODAL-BTN" data-target="#modalHeightFullSample01">모달 높이만 full</button>
            <button type="button" class="btn MODAL-BTN" data-target="#modalHeightFullSample02">모달 높이만 full - Long</button><br>
            <br>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample03">모달 높이만 center</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample04">모달 높이만 center1</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample05">모달 높이만 center2</button><br>
            <br>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample06">모달 높이만 full Up</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample07">모달 높이만 full Down</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample08">모달 높이만 full Left</button>
            <button type="button" class="btn btn-black MODAL-BTN" data-target="#modalHeightFullSample09">모달 높이만 full Right</button>
        </div>
        <div class="__class">.MODAL-BTN</div>
    </div>
</div>
<div class="modal-dimmed" id="modalHeightFullSampleOpacityTarget01" data-ani-on="modal-ani-opacity" data-ani-off="modal-ani-opacity-opacity">
...
<div class="modal-dimmed" id="modalHeightFullSampleTarget01">
    <div class="modal-full modal-height-full">
        <div class="modal-wrapper">
            <div class="modal-container">
                <div class="modal-content" data-ani-on="modal-ani-target" data-ani-off="modal-ani-target-target">
...
<div class="modal-dimmed" data-ani-on="modal-ani-big" data-ani-off="modal-ani-big-small" id="modalHeightFullSample03">
...
<div class="modal-dimmed" data-ani-on="modal-ani-big" data-ani-off="modal-ani-big-small" id="modalHeightFullSample05">
    <div class="modal-full">
        <div class="modal-wrapper">
            <div class="modal-container">
                <div class="modal-content" data-ani-on="modal-ani-big" data-ani-off="modal-ani-big-small">
...
<div class="modal-dimmed" id="modalHeightFullSample08">
    <div class="modal-full modal-height-full">
        <div class="modal-wrapper">
            <div class="modal-container">
...
<div class="modal-dimmed" id="modalHeightFullSample09">
    <div class="modal-full modal-height-full">
        <div class="modal-wrapper">
            <div class="modal-container">
